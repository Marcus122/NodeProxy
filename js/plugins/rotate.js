...
function canvas360(params) {
   ...
   */
  params.loaderFillColor = params.loaderFillColor || '#ffffff';
  /**
  ...
  startPreload = function() {
    ...
    if(params.logoImagePath){
        ...
        for ( i = 0; i < params.framesCount; i++) {
            ...
            frameImages[i].src = params.framesFile ? params.framesPath + params.framesFile.replace('{col}', repVal) : params.images[i];
        }
        setTimeout(function() {
            preloadImages();
        }, 20);
